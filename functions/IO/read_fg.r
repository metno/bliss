...
#  fg_env$ktot_dim, total number of ensemble members in all files
#
#  fg_env$fg[[f]]$r_main, raster with the data in the f-th file (raster stack)
#  fg_env$fg[[f]]$k_dim, number of ensemble in the f-th file
#
#  fg_env$fg[[f]]$main.file
#  fg_env$fg[[f]]$varname
#  fg_env$fg[[f]]$topdown
#  fg_env$fg[[f]]$main.proj4
#  fg_env$fg[[f]]$main.proj4_var
#  fg_env$fg[[f]]$main.proj4_att
#  fg_env$fg[[f]]$main.dimnames
#  fg_env$fg[[f]]$main.ndim
#  fg_env$fg[[f]]$main.t
#  fg_env$fg[[f]]$main.tpos
#  fg_env$fg[[f]]$main.epos
#  fg_env$fg[[f]]$main.e
#  fg_env$fg[[f]]$main.acc
#  fg_env$fg[[f]]$main.cfact
#  fg_env$fg[[f]]$main.offset
#  fg_env$fg[[f]]$main.varname_lat
#  fg_env$fg[[f]]$main.varname_lon
#  fg_env$fg[[f]]$main.ndim_ll
#  fg_env$fg[[f]]$main.tpos_ll
#  fg_env$fg[[f]]$main.epos_ll
#  fg_env$fg[[f]]$main.dimnames_ll
#==============================================================================
