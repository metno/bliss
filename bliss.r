...
p <- add_argument(p, "--ensip.rloc_min",
                  ...
                  type="numeric",
                  default=0)
p <- add_argument(p, "--ensip.henoi_alt",
                  help="Alternative HEnOI",
                  flag=T)
...
# ===>  ensip  <===
  ...
  source(file.path(argv$path2src,"henoi_alt.r"))
  source(file.path(argv$path2src,"distance_closest_k_obs.r"))
  source(file.path(argv$path2src,"gamma_anamorphosis.r"))
  source(file.path(argv$path2src,"gamma_get_shape_rate_from_dataset.r"))
